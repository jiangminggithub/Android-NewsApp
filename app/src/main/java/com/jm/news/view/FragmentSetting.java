...
public class FragmentSetting extends PreferenceFragment {
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        Log.d(TAG, "onPreferenceTreeClick: key=" + key + ", preference=" + preference);
        ...
        try {
            ...
            preAutoRun.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                ...
                public boolean onPreferenceChange(Preference preference, Object newValue) {
                    Log.d(TAG, "onPreferenceChange: newsValue=" + newValue + ", key=" + preference.getKey());
            ...
            String appVersion = mViewModel.getFerenceString(keyVersion, Common.getInstance().getResourcesString((R.string.app_version)));
