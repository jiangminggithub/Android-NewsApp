...
public class MImageViewBase extends AppCompatImageView {
    private int width;
    private int height;
    ...
    public MImageViewBase(Context context) {
        super(context);
        init(context, null);
    }

    public MImageViewBase(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public MImageViewBase(Context context, AttributeSet attrs, int defStyleAttr) {
