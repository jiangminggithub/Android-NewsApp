...
public class SimpleToolbar extends Toolbar {
    ...
    private void init(Context context) {
        ...
        mTxtLeftTitle = (TextView) findViewById(R.id.tv_head_back);
        mTxtMiddleTitle = (TextView) findViewById(R.id.tv_head_title);
        mTxtRightTitle = (TextView) findViewById(R.id.head_plus);
    }
